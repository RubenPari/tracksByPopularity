        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    UserId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    SpotifyUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpotifyLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpotifyLinks_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpotifyLinks_SpotifyUserId",
                table: "SpotifyLinks",
                column: "SpotifyUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SpotifyLinks_UserId",
                table: "SpotifyLinks",
                column: "UserId",
                unique: true);
